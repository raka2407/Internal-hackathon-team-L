 ...
 * @author AB62031
 */
public class OnlineShopping extends javax.swing.JFrame {

    /**
     * Creates new form OnlineShopping
     */
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(310, 434));
        setResizable(false);
        ...
        jLabel4.setText("Elkjøp");

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel5.setText("Shopping Advice");

        jTextField1.setText("Options that will meet your preferences");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OnlineShopping.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
